...
// device_In_Family là kiểm tra xem con ESP32 có ở gần hay không
// isSpamming là chỉ để gửi notification 1 lần ( bao gồm noti trên blynk + gmail )

int count =-1, timeAllowedDangerous = 30000, timeAllowedSafe = 6000;

//
char ssid[] = "Luan Tran"; // THAY ĐỔI BẰNG MẠNG ĐANG SỬ DỤNG 
char pass[] = "luantran1997";// THAY ĐỔI BẰNG MẠNG ĐANG SỬ DỤNG  

const int PIN = 2;
const int CUTOFF = -60; // TĂNG KHOẢNG CÁCH NHẬN TÍN HIỆU CHO CON ESP32, CÀNG NHỎ CÀNG NHẬN ĐƯỢC XA. 
...
// isPossibleToCreate cho phép tạo mật khẩu 
...
BLYNK_WRITE(V2) // LẤY TÍN HIỆU TỪ APP BLYNK, NẾU NHƯ BUTTON ĐƯỢC BẬT THÌ CHO PHÉP NHẬP MẬT KHẨU 
{ 
...
void manufactureDataPrint(BLEAdvertisedDevice device) { // CÁI NÀY THÌ TUI HOK BIẾT, HỎI ANH VINH Á. 
